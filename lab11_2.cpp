...
int calScore(int x,int y,int z){
        ...
        return sum%10;	//Write the function to calculate the score with is the rightmost digit of summation of the scores from three cards.
		//Return the score.
	...
	int main(){	
		...
		int playerScore =0, yugiScore, playerAction, yugiAction;
